// module.exports = {
    fs= require('fs');
    path= require('path');
    _configurations= require('../src/assets/configurationData/configuration.json');
    CultureResourceIncluder= require('./getCultureResources');
    ...
    // terminalCommandRunner: function (commandtoRun) {
            ...
            list.forEach((file) => {
                ...
                try {
                    ...
                    if (stat && stat.isDirectory()) {
                        ...
                        //     this.CultureResourceIncluder.getModuleCulture(moduleName);
                        // }
                        //results.push(file);
                        if (!--pending) {
                            return 1
